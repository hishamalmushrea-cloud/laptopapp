...
> **محدّث: CI مفعَّل وناجح.** أول بناء مكتمل: الوسم `dev-20260911-3`،
> run `34535792988` → `34537609826`. الملف مثبَّت الآن في `.github/workflows/build.yml`.
> ما يلي يشرح لماذا كان في `ci/` بدايةً.
